...
// Lightweight local Card component to avoid relying on a missing ../components/ui/Card module.
type CardProps = {
...
const Card: React.FC<CardProps> = ({ children, onClick, className }) => (
  <div
    ...
    className={`bg-white dark:bg-slate-800 rounded-xl p-5 shadow-sm hover:shadow-md transition ${className ?? ''}`}
  >
    {children}
  </div>
);
